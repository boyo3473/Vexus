...
function crypt.generatekey(length)
    length = length or 32
    return crypt.generatebytes(length)
end

-- Dummy hash: returns GUID without dashes for supported algorithms (stub)
function crypt.hash(data, algo)
    assert(type(data) == "string", "string expected")
    algo = string.lower(algo or "sha256")
    if algo == "md5" or algo == "sha1" or algo == "sha256" or algo == "sha384" or algo == "sha512" or algo == "sha3-224" or algo == "sha3-256" or algo == "sha3-512" then
